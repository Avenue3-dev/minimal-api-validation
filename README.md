...
builder.Services.AddEndpointValidation<Program>(options =>
{
    // the defalut value is "MinimalApiValidation"
...
## Validation
The package provides several features to help you validate incoming requests:
...
```json
{
    "errors": {
        ...
        "Age": [
            "The Age field must be between 1 and 100."
        ]
    }
}
```
