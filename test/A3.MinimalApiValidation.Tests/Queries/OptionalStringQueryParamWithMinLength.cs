...
public class OptionalStringQueryParamWithMinLength : TestBase
{
    public OptionalStringQueryParamWithMinLength(WebApplicationFactory<Program> factory) : base(factory)
    {
    }
