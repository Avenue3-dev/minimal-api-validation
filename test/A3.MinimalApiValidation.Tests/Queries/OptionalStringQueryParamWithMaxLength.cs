namespace A3.MinimalApiValidation.Tests.Queries;
...
public class OptionalStringQueryParamWithMaxLength : TestBase
{
    public OptionalStringQueryParamWithMaxLength(WebApplicationFactory<Program> factory) : base(factory)
    {
    }
