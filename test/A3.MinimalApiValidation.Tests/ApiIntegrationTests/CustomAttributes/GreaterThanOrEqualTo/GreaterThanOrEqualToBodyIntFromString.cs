...
public class GreaterThanOrEqualToBodyIntFromString : TestBase
{
    public GreaterThanOrEqualToBodyIntFromString(WebApplicationFactory<Program> factory) : base(factory)
    {
    }
