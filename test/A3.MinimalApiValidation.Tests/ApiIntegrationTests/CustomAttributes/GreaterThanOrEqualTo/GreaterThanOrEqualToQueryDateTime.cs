...
public class GreaterThanOrEqualToQueryDateTime : TestBase
{
    public GreaterThanOrEqualToQueryDateTime(WebApplicationFactory<Program> factory) : base(factory)
    {
    }
    ...
    protected override void AddTestEndpoint(IEndpointRouteBuilder app)
    {
        app.MapGet(Path, (
            ...
            [FromQuery, GreaterThanOrEqualTo("2021-02-02")] DateTime query2
        ) => TypedResults.Ok());
    }
