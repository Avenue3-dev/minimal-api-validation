...
public class GreaterThanOrEqualToBodyDateTimeCompare : TestBase
{
    public GreaterThanOrEqualToBodyDateTimeCompare(WebApplicationFactory<Program> factory) : base(factory)
    {
    }
