...
public class GreaterThanOrEqualToHeaderDateTime : TestBase
{
    public GreaterThanOrEqualToHeaderDateTime(WebApplicationFactory<Program> factory) : base(factory)
    {
    }
    ...
    protected override void AddTestEndpoint(IEndpointRouteBuilder app)
    {
        app.MapGet(Path, (
            ...
            [FromHeader(Name = "header-2"), GreaterThanOrEqualTo("2021-02-02")] DateTime header2
        ) => TypedResults.Ok());
    }
