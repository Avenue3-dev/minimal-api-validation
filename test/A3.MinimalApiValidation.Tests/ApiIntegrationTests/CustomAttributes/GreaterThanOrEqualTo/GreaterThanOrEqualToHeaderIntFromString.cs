...
public class GreaterThanOrEqualToHeaderIntFromString : TestBase
{
    public GreaterThanOrEqualToHeaderIntFromString(WebApplicationFactory<Program> factory) : base(factory)
    {
    }
    ...
    protected override void AddTestEndpoint(IEndpointRouteBuilder app)
    {
        app.MapGet(Path, (
            ...
            [FromHeader(Name = "header-2"), GreaterThanOrEqualTo("5")] int header2
        ) => TypedResults.Ok());
    }
