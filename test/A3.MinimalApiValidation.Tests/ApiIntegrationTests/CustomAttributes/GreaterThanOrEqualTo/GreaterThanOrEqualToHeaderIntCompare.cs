...
public class GreaterThanOrEqualToHeaderIntCompare : TestBase
{
    public GreaterThanOrEqualToHeaderIntCompare(WebApplicationFactory<Program> factory) : base(factory)
    {
    }
    ...
    protected override void AddTestEndpoint(IEndpointRouteBuilder app)
    {
        app.MapGet(Path, (
            ...
            [FromHeader(Name = "header-2"), GreaterThanOrEqualTo("header-1")] int header2
        ) => TypedResults.Ok());
    }
