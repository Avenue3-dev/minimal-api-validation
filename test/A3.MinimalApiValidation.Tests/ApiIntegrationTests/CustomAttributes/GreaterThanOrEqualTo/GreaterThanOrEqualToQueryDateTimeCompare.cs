...
public class GreaterThanOrEqualToQueryDateTimeCompare : TestBase
{
    public GreaterThanOrEqualToQueryDateTimeCompare(WebApplicationFactory<Program> factory) : base(factory)
    {
    }
    ...
    protected override void AddTestEndpoint(IEndpointRouteBuilder app)
    {
        app.MapGet(Path, (
            ...
            [FromQuery, GreaterThanOrEqualTo(nameof(query1))] DateTime query2
        ) => TypedResults.Ok());
    }
