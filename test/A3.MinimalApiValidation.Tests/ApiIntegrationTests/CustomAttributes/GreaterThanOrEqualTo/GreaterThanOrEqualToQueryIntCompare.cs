...
public class GreaterThanOrEqualToQueryIntCompare : TestBase
{
    public GreaterThanOrEqualToQueryIntCompare(WebApplicationFactory<Program> factory) : base(factory)
    {
    }
    ...
    protected override void AddTestEndpoint(IEndpointRouteBuilder app)
    {
        app.MapGet(Path, (
            ...
            [FromQuery, GreaterThanOrEqualTo(nameof(query1))] int query2
        ) => TypedResults.Ok());
    }
