...
public class GreaterThanOrEqualToQueryIntFromString : TestBase
{
    public GreaterThanOrEqualToQueryIntFromString(WebApplicationFactory<Program> factory) : base(factory)
    {
    }
    ...
    protected override void AddTestEndpoint(IEndpointRouteBuilder app)
    {
        app.MapGet(Path, (
            ...
            [FromQuery, GreaterThanOrEqualTo("5")] int query2
        ) => TypedResults.Ok());
    }
