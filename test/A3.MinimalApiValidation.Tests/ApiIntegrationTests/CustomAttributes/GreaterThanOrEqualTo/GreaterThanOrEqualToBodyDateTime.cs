...
public class GreaterThanOrEqualToBodyDateTime : TestBase
{
    public GreaterThanOrEqualToBodyDateTime(WebApplicationFactory<Program> factory) : base(factory)
    {
    }
    ...
    [InlineData("2020-07-01T15:00:00")]
    ...
    public async Task returns_bad_request_when_model_property_is_lesser(string value)
    {
        // Arrange
        var body = new
        {
    ...
    public class TestModel
    {
        ...
        [GreaterThanOrEqualTo("2020-05-05T12:45:00")]
