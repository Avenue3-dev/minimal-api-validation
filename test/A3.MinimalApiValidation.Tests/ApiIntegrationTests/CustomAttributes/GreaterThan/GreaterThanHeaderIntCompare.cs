...
public class GreaterThanHeaderIntCompare : TestBase
{
    public GreaterThanHeaderIntCompare(WebApplicationFactory<Program> factory) : base(factory)
    {
    }
    ...
    protected override void AddTestEndpoint(IEndpointRouteBuilder app)
    {
        app.MapGet(Path, (
            ...
            [FromHeader(Name = "header-2"), GreaterThan("header-1")] int header2
        ) => TypedResults.Ok());
    }
