...
public class MinHeaderDateTime: TestBase
{
    public MinHeaderDateTime(WebApplicationFactory<Program> factory) : base(factory)
    {
    }
    ...
    {
        app.MapGet(Path, (
            [FromHeader(Name = "x-header-1"), Min("2022-02-22")] DateTime header1
        ) => TypedResults.Ok());
    }
