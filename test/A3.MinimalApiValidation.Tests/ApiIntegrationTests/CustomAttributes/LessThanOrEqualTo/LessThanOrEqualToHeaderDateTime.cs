...
public class LessThanOrEqualToHeaderDateTime : TestBase
{
    public LessThanOrEqualToHeaderDateTime(WebApplicationFactory<Program> factory) : base(factory)
    {
    }
    ...
    protected override void AddTestEndpoint(IEndpointRouteBuilder app)
    {
        app.MapGet(Path, (
            ...
            [FromHeader(Name = "header-2"), LessThanOrEqualTo("2021-02-02")] DateTime header2
        ) => TypedResults.Ok());
    }
