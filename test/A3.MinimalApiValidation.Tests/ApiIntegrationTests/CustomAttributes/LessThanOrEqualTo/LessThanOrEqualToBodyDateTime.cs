...
public class LessThanOrEqualToBodyDateTime : TestBase
{
    public LessThanOrEqualToBodyDateTime(WebApplicationFactory<Program> factory) : base(factory)
    {
    }
    ...
    public class TestModel
    {
        ...
        [LessThanOrEqualTo("2020-05-05T12:45:00")]
