...
public class LessThanOrEqualToQueryDateTimeCompare : TestBase
{
    public LessThanOrEqualToQueryDateTimeCompare(WebApplicationFactory<Program> factory) : base(factory)
    {
    }
    ...
    protected override void AddTestEndpoint(IEndpointRouteBuilder app)
    {
        app.MapGet(Path, (
            ...
            [FromQuery, LessThanOrEqualTo(nameof(query1))] DateTime query2
        ) => TypedResults.Ok());
    }
