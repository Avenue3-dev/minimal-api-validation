...
public class LessThanOrEqualToHeaderIntFromString : TestBase
{
    public LessThanOrEqualToHeaderIntFromString(WebApplicationFactory<Program> factory) : base(factory)
    {
    }
    ...
    protected override void AddTestEndpoint(IEndpointRouteBuilder app)
    {
        app.MapGet(Path, (
            ...
            [FromHeader(Name = "header-2"), LessThanOrEqualTo("5")] int header2
        ) => TypedResults.Ok());
    }
