...
public class LessThanOrEqualToHeaderIntCompare : TestBase
{
    public LessThanOrEqualToHeaderIntCompare(WebApplicationFactory<Program> factory) : base(factory)
    {
    }
    ...
    protected override void AddTestEndpoint(IEndpointRouteBuilder app)
    {
        app.MapGet(Path, (
            ...
            [FromHeader(Name = "header-2"), LessThanOrEqualTo("header-1")] int header2
        ) => TypedResults.Ok());
    }
