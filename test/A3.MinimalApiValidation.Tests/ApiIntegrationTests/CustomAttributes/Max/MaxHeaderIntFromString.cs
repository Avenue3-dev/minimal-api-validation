namespace A3.MinimalApiValidation.Tests.ApiIntegrationTests.CustomAttributes.Max;
...
public class MaxHeaderIntFromString: TestBase
{
    public MaxHeaderIntFromString(WebApplicationFactory<Program> factory) : base(factory)
    {
    }
    ...
    {
        app.MapGet(Path, (
            [FromHeader(Name = "x-header-1"), Max("3")] int header1
        ) => TypedResults.Ok());
    }
