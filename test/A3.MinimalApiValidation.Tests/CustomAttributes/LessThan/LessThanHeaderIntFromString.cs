...
public class LessThanHeaderIntFromString : TestBase
{
    public LessThanHeaderIntFromString(WebApplicationFactory<Program> factory) : base(factory)
    {
    }
    ...
    protected override void AddTestEndpoint(IEndpointRouteBuilder app)
    {
        app.MapGet(Path, (
            ...
            [FromHeader(Name = "header-2"), LessThan("5")] int header2
        ) => TypedResults.Ok());
    }
