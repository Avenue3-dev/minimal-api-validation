...
public class GreaterThanBodyDateTime : TestBase
{
    public GreaterThanBodyDateTime(WebApplicationFactory<Program> factory) : base(factory)
    {
    }
    ...
    public class TestModel
    {
        ...
        [GreaterThan("2020-05-05T12:45:00")]
